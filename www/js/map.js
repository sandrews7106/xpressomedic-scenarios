...
const locations = [
  ...
  { id:'bd_cafe',     name:"Big Daddy's Café Royal",       addr:"710 Crown St",        cat:'coffee', icon:'☕', tagline:"Fancy Coffee, Unfancy Problems" },
  { id:'bd_grocery',  name:"Big Daddy's Food King",        addr:"180 Big Daddy Blvd", cat:'retail', icon:'🛒', tagline:"Everything You Need & Then Some" },
  { id:'bd_dollar',   name:"Big Daddy's Dollar Deals",     addr:"450 Papa Drive",      cat:'retail', icon:'🏪', tagline:"Why Pay More? You Already Did." },
  ...
  { id:'bd_laundry',  name:"Big Daddy's Laundromat",       addr:"150 Papa Drive",      cat:'auto',   icon:'👕', tagline:"Open 24 Hrs — Come As You Are" },
